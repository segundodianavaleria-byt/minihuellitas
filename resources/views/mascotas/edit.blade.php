    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-4">
                <h2 class="text-2xl font-bold text-white">Editar Mascota</h2>
                <p class="text-orange-100">Actualiza los datos de {{ $mascota->nombre }}</p>
            </div>
            
            <form method="POST" action="{{ route('mascotas.update', $mascota->id) }}" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="edad" step="0.5" value="{{ old('edad', $mascota->edad) }}" 
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-orange-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="peso" value="{{ old('peso', $mascota->peso) }}" 
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-orange-500">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="observaciones_medicas" rows="3" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-orange-500" 
                        placeholder="Alergias, condiciones médicas, medicamentos, etc.">{{ old('observaciones_medicas', $mascota->observaciones_medicas) }}</textarea>
                </div>
